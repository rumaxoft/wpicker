...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Wpicker; });
...
var Wpicker = /*#__PURE__*/function () {
  /**
   * Create a Wpicker
   * @param {Object} options
   */
  function Wpicker(options) {
    _classCallCheck(this, Wpicker);

    var defaults = {
      elem: '',
      // css selector
      type: 'infinite',
      // infinite scroll, normal non-infinite
      // eslint-disable-next-line max-len
      qty: 20,
      // wheel size, the number of items in the wheel, must be set to a multiple of 4
      sensitivity: 1.5,
      source: [],
      // list of items {value: xx, text: xx},
      value: null,
      onChange: null
    };
    ...
    this.isFirefox = typeof InstallTrigger !== 'undefined'; // firefox has another deltaY on wheel event

    this.wheelMultiplicator = this.isFirefox ? 5 : 0.7; // calculating height from circumference
    // eslint-disable-next-line max-len

    this.itemHeight = Math.floor(this.elems.elem.clientHeight * Math.PI / this.options.qty); // degree of rotation between each item

    this.itemAngle = 360 / this.options.qty; // wheel radius
  ...
  _createClass(Wpicker, [{
    ...
    value: function _create(source) {
      ...
      var template = "\n      <div class=\"wpicker__viewport\"\n        style=\"height: ".concat(this.itemHeight, "px\";\n      </div>\n      <ul class=\"wpicker__list\"\n        style=\"transform: translate3d(0, 0, ").concat(-this.radius, "px)\n                          rotateX(0deg);\n              height: ").concat(this.itemHeight, "px\"\n      >\n          {{list}}\n      </ul>\n    ");
      ...
      for (var i = 0; i < source.length; i++) {
        list += "<li class= \"wpicker__item\"\n                  style=\"\n                  height: ".concat(this.itemHeight, "px;\n                  transform: rotateX(").concat(-this.itemAngle * i, "deg)\n                              translate3d(0, 0, ").concat(this.radius, "px);\"\n                  data-index= \"").concat(i, "\">\n                    <div class=\"wpicker__item-content\">").concat(source[i].text, "<div>\n                </li>");
      }

      if (this.options.type === 'infinite') {
        // list head and tail
        for (var _i = 0; _i < this.quarterQty; _i++) {
          // head
          list = "<li class=\"wpicker__item\"\n                  style=\"\n                  height: ".concat(this.itemHeight, "px;\n                  transform: rotateX(").concat(this.itemAngle * (_i + 1), "deg)\n                              translate3d(0, 0, ").concat(this.radius, "px);\"\n                  data-index=\"").concat(-_i - 1, "\">\n                    <div class=\"wpicker__item-content\">\n                      ").concat(source[sourceLength - _i - 1].text, "\n                    <div>\n                </li>") + list; // tail

          list += "<li class=\"wpicker__item\"\n                  style=\"\n                  height: ".concat(this.itemHeight, "px;\n                  transform: rotateX(").concat(-this.itemAngle * (_i + sourceLength), "deg)\n                              translate3d(0, 0, ").concat(this.radius, "px);\"\n                  data-index=\"").concat(_i + sourceLength, "\">\n                    <div class=\"wpicker__item-content\">\n                      ").concat(source[_i].text, "\n                    <div>\n                </li>");
        }
      }
    ...
    value: function _touchmove(e, touchData) {
      ...
      var moveToScroll = scrollAdd + this.currentScroll;
    ...
    value: function _touchend(e, touchData) {
      ...
      if (touchData.yArr.length === 1) {
        ...
        var endY = touchData.yArr[touchData.yArr.length - 1][0]; // calculation speed (itemHeight/second)
    ...
    value: function _wheel(e) {
      ...
      var scrollAdd = e.deltaY / this.itemHeight * this.wheelMultiplicator;
      var moveToScroll = this.currentScroll + scrollAdd;
      ...
      this.wheelCallback = setTimeout(function () {
        _this2._selectByScroll(_this2.currentScroll);
      }, 300);
    }
    /**
    ...
    key: "_moveWheel",
    value: function _moveWheel(scroll) {
      var _this3 = this;
      ...
      this.elems.list.style.transform = "translate3d(0, 0, ".concat(-this.radius, "px)\n                                        rotateX(").concat(this.itemAngle * scroll, "deg)");

      _toConsumableArray(this.elems.items).forEach(function (itemElem) {
        if (Math.abs(itemElem.dataset.index - scroll) > _this3.quarterQty) {
    ...
    key: "_preventOverscrolling",
    value: function _preventOverscrolling(scroll) {
      if (scroll < 0) {
        scroll *= 0.3;
    ...
    value: function () {
      var _animateMoveByInitV2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(initV) {
        var initScroll, finalScroll, totalScrollLen, a, t;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 11:
                ...
                totalScrollLen = finalScroll - initScroll; // eslint-disable-next-line max-len

                _context.next = 20;
                return this._animateToScroll(this.currentScroll, finalScroll, t, 'easeOutQuart');
              ...
              case 22:
                ...
                finalScroll = Math.round(this.currentScroll + totalScrollLen); // eslint-disable-next-line max-len
    ...
    value: function _animateToScroll(initScroll, finalScroll, t) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        var tick = function tick() {
          ...
          if (pass < t) {
            var delta = easing[easingName](pass / t) * totalScrollLen;
            _this4.currentScroll = _this4._moveWheel(initScroll + delta);
            _this4.moveT = requestAnimationFrame(tick);
          } else {
            resolve();

            _this4._stop();

            _this4.currentScroll = _this4._moveWheel(initScroll + totalScrollLen);
          }
        };
    ...
    key: "_selectByScroll",
    value: function () {
      var _selectByScroll2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(scroll) {
        var initScroll;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 7;
                return this._animateToScroll(initScroll, scroll, 0.3, 'easeOutQuart');
      ...
      function _selectByScroll(_x2) {
        return _selectByScroll2.apply(this, arguments);
      }

      return _selectByScroll;
    }()
    /**
    ...
    value: function select(value) {
      ...
      var _loop = function _loop(i) {
        if (_this5.source[i].value === value) {
          window.cancelAnimationFrame(_this5.moveT);

          var initScroll = _this5._normalizeScroll(_this5.currentScroll);

          var finalScroll = i;
          var t = Math.sqrt(Math.abs((finalScroll - initScroll) / _this5.a));

          _this5._animateToScroll(initScroll, finalScroll, t);

          setTimeout(function () {
            return _this5._selectByScroll(i);
          });
          return {
            v: void 0
          };
      ...
      throw new Error("Can't select value: ".concat(value, ",\n                    ").concat(value, " doesn't exist in source list"));
    }
    /**
     * Destroy wheel
     */
    ...
    value: function destroy() {
      this._stop(); // document event remove


      for (var eventName in this.events) {
        if ({}.hasOwnProperty.call(this.events, eventName)) {
          // eslint-disable-next-line max-len
          this.elems.elem.removeEventListener("".concat(eventName), this.events[eventName]);
        }
      }

      this.elems.elem.removeEventListener('mousedown', this.events['touchstart']);
      document.removeEventListener('mousemove', this.events['touchmove']);
      document.removeEventListener('mouseup', this.events['touchend']); // remove element
