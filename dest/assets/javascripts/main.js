...
var WheelPicker = /*#__PURE__*/function () {
  ...
  _createClass(WheelPicker, [{
    ...
    value: function _create(source) {
      ...
      if (this.options.type === 'infinite') {
        ...
        for (var _i = 0; _i < this.quarterQty; _i++) {
          // head
          list = "<li class=\"wpicker__item\"\n                  style=\"\n                  height: ".concat(this.itemHeight, "px;\n                  transform: rotateX(").concat(this.itemAngle * (_i + 1), "deg) translate3d(0, 0, ").concat(this.radius, "px);\"\n                  data-index=\"").concat(-_i - 1, "\">\n                    <div class=\"wpicker__item-content\">\n                      ").concat(source[sourceLength - _i - 1].text, "\n                    <div>\n                </li>") + list; // tail

          list += "<li class=\"wpicker__item\"\n                  style=\"\n                  height: ".concat(this.itemHeight, "px;\n                  transform: rotateX(").concat(-this.itemAngle * (_i + sourceLength), "deg) translate3d(0, 0, ").concat(this.radius, "px);\"\n                  data-index=\"").concat(_i + sourceLength, "\">\n                    <div class=\"wpicker__item-content\">\n                      ").concat(source[_i].text, "\n                    <div>\n                </li>");
        }
      }
    ...
    value: function _touchmove(e, touchData) {
      ...
      var moveWheelScroll = scrollAdd + this.currentScroll;
    ...
    value: function _wheel(e) {
      ...
      var moveWheelScroll = this.currentScroll + scrollAdd;
    ...
    value: function _moveWheel(scroll) {
      ...
      this.elems.list.style.transform = "translate3d(0, 0, ".concat(-this.radius, "px) rotateX(").concat(this.itemAngle * scroll, "deg)");
    ...
    */
    ...
    value: function _animateToScroll(initScroll, finalScroll, t) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        var tick = function tick() {
          ...
          if (pass < t) {
            _this4.currentScroll = _this4._moveWheel(initScroll + easing[easingName](pass / t) * totalScrollLen);
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 7;
                return this._animateToScroll(initScroll, scroll, 1, 'easeOutQuart');
    ...
    value: function select(value) {
      ...
      throw new Error("Can't select value: ".concat(value, ", ").concat(value, " doesn't exist in source list"));
    }
  }, {
    key: "destroy",
...
var elem = '.wpicker';
var wheelPicker = new WheelPicker({
  elem: '.wpicker',
  qty: 21,
  type: 'infinite',
  source: source,
  onChange: function onChange(selected) {// console.log(selected)
  }
});
wheelPicker.init();
setTimeout(function () {
