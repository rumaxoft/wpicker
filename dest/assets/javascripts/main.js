...
var WheelPicker = /*#__PURE__*/function () {
  function WheelPicker(elem, qty, source) {
  ...
  _createClass(WheelPicker, [{
    ...
    value: function init() {
      ...
      for (var eventName in this.events) {
        this.events[eventName] = function (eventName) {
          return function (e) {
            if (_this.elem.contains(e.target) || e.target === _this.elem) {
              e.preventDefault();
    ...
    value: function _moveWheel(scroll) {
      this.list.style.transform = "translate3d(0, 0, ".concat(-this.radius, "px) rotateX(").concat(this.itemAngle * scroll, "deg)");
      return scroll;
    }
  }]);
...
var source = getNumbers(1, 20);
var elem = document.querySelector('.wpicker');
var wheelPicker = new WheelPicker(elem, source.length, source);
wheelPicker.init();
